  ...
  (self["webpackChunkHRMS_Plus"] = self["webpackChunkHRMS_Plus"] || []).push([["src_app_tab1_tab1_module_ts"], {
    ...
    46923: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(geolocation, device, toastController, db, modalcontroller, alertCtrl, platform, menuCtrl, router, CG) {
        ...
        _createClass(Tab1Page, [{
          key: "modallll",
          value: function modallll() {
            this.UserdetailComponentmodal();
          }
        }, {
          key: "UserdetailComponentmodal",
          value: function UserdetailComponentmodal() {
          ...
          value: function ionViewWillEnter() {
            ...
            this.menuList = [{
              ...
              'icons': 'assets/image/checkin2.png',
              'menuName': 'Check In',
              'pageRoute': '/checkin'
            }, {
          ...
          key: "ionViewDidEnter",
          value: function ionViewDidEnter() {// this.profiledatass();
          }
        }, {
          key: "Logout",
          ...
          value: function getProfile() {
            ...
            this.db.getProfileData(this.para).subscribe(function (res) {
              ...
              _this2.empName = _this2.profiledata.empName;
              _this2.profilePic = _this2.profiledata.profilePic;

              _this2.db.sendProfile(_this2.profiledata);
            });
          }
        }]);
      ...
      _Tab1Page = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
        selector: 'app-tab1',
