  ...
  (self["webpackChunkHRMS_Plus"] = self["webpackChunkHRMS_Plus"] || []).push([["src_app_login_login_module_ts"], {
    ...
    80107: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _LoginPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _material_module__WEBPACK_IMPORTED_MODULE_0__.MaterialModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _login_routing_module__WEBPACK_IMPORTED_MODULE_1__.LoginPageRoutingModule],
    ...
    66825: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginPage = /*#__PURE__*/function () {
        function LoginPage(db, device, alertController, toastController, router, CG) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function GetDevice() {
            ...
            this.db.login(parameter).subscribe(function (data) {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 14:
                        if (!(this.LoginRes[0].status == "Pending")) {
                          _context.next = 22;
                          break;
                        }
                        ...
                        _context.next = 17;
                        return this.toastController.create({
                          message: "".concat(this.LoginRes[0].message),
                          duration: 3000
                        });
          ...
          value: function resetPass(name) {
            ...
            if (!name.EmpID) {
              ...
              this.db.resetPassword(para).subscribe(function (res) {
          ...
          value: function makeAttendanceCheckIN() {
            ...
            this.db.ValidateCheckin(this.para).subscribe(function (res) {
              ...
              return (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(_this4, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
      ...
      _LoginPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-login',
